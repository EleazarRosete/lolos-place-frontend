    ...
    function DeliveriesCard() {
            ...
            try {
                ...
                if (message === "Reservation accepted.") {
                    ...
                    setReservations(prevState => ({
                        today: prevState.upcoming.map(reservation =>
        ...
        const getReservations = async () => {
            try {
                ...
                console.log(reservations.upcoming);
            } catch (err) {
        ...
        const openModal = (reservationDetails) => {
            console.log(reservationDetails.acceptance_status);
        ...
        return (
            <section className={styles.section}>
                ...
                reservations.upcoming.map(({ reservation_id, first_name, last_name, guest_number, reservation_date, reservation_time, acceptance_status }) => (
