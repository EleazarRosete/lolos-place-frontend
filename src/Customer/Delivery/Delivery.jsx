...
const Delivery = () => {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      const response = await axios.post('https://lolos-place-frontend.onrender.com/api/orders', orderDetails);
  ...
  const makePaymentGCash = async () => {
    ...
    try {
        const response = await axios.post('https://lolos-place-frontend.onrender.com/api/create-gcash-checkout-session', body);
